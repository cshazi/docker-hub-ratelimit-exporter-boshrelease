...
# The base manifests/docker-hub-ratelimit-exporter.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/docker-hub-ratelimit-exporter.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
